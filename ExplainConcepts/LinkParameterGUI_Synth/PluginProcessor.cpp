...
#endif
{
    ...
    // filter parameter hinzufuegen
    m_filterparams.addParameter(m_parameterVector);

    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("NanoVTS"),
        AudioProcessorValueTreeState::ParameterLayout(m_parameterVector.begin(), m_parameterVector.end()));
...
{
    return new NanoAudioProcessorEditor(*this,*m_parameterVTS);
}
